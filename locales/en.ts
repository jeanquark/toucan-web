export default {
    "welcome": "Welcome",
    motto: "We create colorful and eye-catching websites",
    "sub_motto": "And bring you to success",
    ...
    "packages": [
        {
            ...
            "asset1": "Your website",
            "asset2": "Prof. Emails",
            "asset3": "SEO optimized"
        },
        {
            "title": "Classic Pack",
            "asset1": "Your website",
            "asset2": "Full admin panel",
            "asset3": "Custom functions"
        },
        {
            "title": "Full Pack",
            "asset1": "Your website",
            "asset2": "Complex logic",
            "asset3": "High traffic"
        }
    ],
    testimonials: {
    ...
    team_members: {
        0: {
            name: "Jean-Marc",
            role: "Web developer",
            content: "4 years experience with backend and frontend technologies (Laravel, VueJS, ReactJS, Node). Certified webmaster from HES-SO Valais and Amazon Cloud Architect.",
            image: "jeanmarc.jpg"
        },
        1: {
            name: "Ivan",
            role: "Data analyst",
            content: "Econometrician with 5 years of experience as an analyst and research. Experience with Google Analytics, E-commerce, and online marketing.",
            image: "ivan.jpg"
        },
        2: {
            name: "Mary",
            role: "Graphic designer",
            content: "Graphic designer focused on the development of illustration, packaging design, branding, corporate image and advertising starting from different approaches to get unique designs.",
            image: "mary.jpg"
        }
    },
    "contact": {
