export default {
    "welcome": "Bienvenue",
    "motto": "Nous créons votre prochain site web",
    "sub_motto": "Et vous accompagnons jusqu'au succès",
    ...
    "packages": [
        ...
        },
        {
            ...
            "asset1": "Votre site web",
            "asset2": "Panel admin",
            "asset3": "Functions pers."
        },
        {
            "title": "Pack complet",
            "asset1": "Votre site web",
            "asset2": "Logique complexe",
            "asset3": "Trafic important"
        }
    ],
    "testimonials": [
        {
    ...
    "company": {
        ...
        "content": "Nous sommes une petite équipe de designers, analystes et développeurs utilisant les dernières technologies du web pour créer des sites innovants. Nous sommes là pour vous aider à optimiser votre présence digitale."
    },
    "team_members": [
        {
            "name": "Jean-Marc",
            "role": "Développeur web",
            "content": "4 ans d'expérience avec les technologies backend et frontend (Laravel, VueJS, ReactJS, Node). Certifié Webmaster à la HES-SO Valais et spécialiste Amazon cloud.",
            "image": "jeanmarc.jpg"
        },
        {
            "name": "Ivan",
            "role": "Analyste quantitatif",
            "content": "Econométricien avec 5 ans d'expérience en tant qu'analyste et chercheur. Expérience avec Google Analytics, le marketing en ligne et l'optimisation des sites e-commerce.",
            "image": "ivan.jpg"
        },
        {
            "name": "Mary",
            "role": "Graphiste",
            "content": "Crée des images d'illustration personnalisées pour le web, le design d'emballage, les marques et la publicité.",
            "image": "mary.jpg"
        }
    ],
    "contact": {
        "title": "Contactez-nous",
        "content": "Pour une prise de contact ou toute question que vous pourriez avoir, n'hésitez pas à faire usage du formulaire ci-dessous. Nous vous répondrons dans les plus brefs délais."
    },
    "form": {
        "name": "Nom",
        "firstname": "Prénom",
